...
library NoDeltaPietrzakLibrary {
    function verifyReturnGasOfModExp(
        BigNumber[] memory v,
        BigNumber memory x,
        BigNumber memory y,
        BigNumber memory n,
        ...
        if (!BigNumbers.eq(y, BigNumbers.modexp(x, _two, n))) return 0;
        return (start - gasleft() - 2);
    }

    function verifyReturnGasOfHalving(
        BigNumber[] memory v,
        BigNumber memory x,
        BigNumber memory y,
        BigNumber memory n,
