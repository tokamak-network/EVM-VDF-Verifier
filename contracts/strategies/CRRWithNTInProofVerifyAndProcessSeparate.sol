...
import "./interfaces/ICRRWithNTInProofVerifyAndProcessSeparate.sol";

contract CRRWithNTInProofVerifyAndProcessSeparate is ICRRWithNTInProofVerifyAndProcessSeparate {
    ...
    function setUp(
        ...
        verifyRecursiveHalvingProof(_proofs, _proofs[ZERO].n, _proofsSize);
