...
const deployRandomDayForTitan: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
...
export default deployRandomDayForTitan
deployRandomDayForTitan.tags = ["all", "randomDay", "testnet", "v2", "anvil", "anvilTitan"]
