...
import { createTestCase30Seconds1 } from "../shared/testFunctionsV2"

!developmentChains.includes(network.name)
    ? describe.skip
    : describe("RandomAirdrop Staging 301 Test", () => {
          //const
          const testcases: TestCase = createTestCase30Seconds1()
          ...
          it("deploy CRRRNGCoordinator Contract", async () => {
              const CRRRNGCoordinator = await ethers.getContractFactory("CRRRNGCoordinator301")
