...
import { createTestCase30Seconds2 } from "../shared/testFunctionsV2"

!developmentChains.includes(network.name)
    ? describe.skip
    : describe("RandomAirdrop Staging 302 Test", () => {
          //const
          const testcases: TestCase = createTestCase30Seconds2()
          ...
          it("deploy CRRRNGCoordinator Contract", async () => {
              const CRRRNGCoordinator = await ethers.getContractFactory("CRRRNGCoordinator302")
